...
Public Class TSAP_MatData
    ...
    Public Sub New(ByRef pPar As SAPCommon.TStr, ByRef pIntPar As SAPCommon.TStr, ByRef pSAPMaterial As SAPMaterial, pFunction As String)
        aPar = pPar
        aIntPar = pIntPar
        aFunction = pFunction
        ...
        If pFunction = "Change" Then
            pSAPMaterial.getMeta_Change(aParamDic, aStrucDic)
        ElseIf pFunction = "GetAll" Then
            pSAPMaterial.getMeta_GetAll(aParamDic, aStrucDic)
        End If
    End Sub
