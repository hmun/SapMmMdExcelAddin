...
Public Class TSAP_GoodsMovementData
    ...
    Public Sub New(ByRef pPar As SAPCommon.TStr, ByRef pIntPar As SAPCommon.TStr, ByRef pSapGoodsMovement As SAPGoodsMovement, pFunction As String)
        aPar = pPar
        aIntPar = pIntPar
        aFunction = pFunction
        ...
        If pFunction = "create" Then
            pSapGoodsMovement.getMeta_Create(aParamDic, aStrucDic)
        End If
    End Sub
